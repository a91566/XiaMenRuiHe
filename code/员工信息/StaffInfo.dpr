...
uses
  ...
  Windows,
  Dialogs,
  U_StaffInfo in 'U_StaffInfo.pas' {F_StaffInfo},
...
function ShowF_StaffInfoApp(var App:TApplication):Boolean; stdcall;
begin
  try
    Application:=App;
    F_StaffInfo := TF_StaffInfo.Create(nil);
    F_StaffInfo.WindowState:=wsMaximized;
    F_StaffInfo.Show;
    Result:=True;
  finally
